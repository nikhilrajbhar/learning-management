        ...
        <div className='form-container'>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value={name} onChange={(e) => setName(e.target.value)} />
